...
class IndiAllskyConfigForm(FlaskForm):
    ...
    IMAGE_STRETCH__MILKYWAY_BROAD_STRUCTURE = FloatField('Milky Way broad structure', validators=[IMAGE_STRETCH__MILKYWAY_BROAD_STRUCTURE_validator], widget=NumberInput(step=0.05))
    IMAGE_STRETCH__MILKYWAY_DARK_STRUCTURE = FloatField('Milky Way dark structure', validators=[IMAGE_STRETCH__MILKYWAY_DARK_STRUCTURE_validator], widget=NumberInput(step=0.05))
