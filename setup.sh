...
if whiptail --title "Optional Python Modules" --yesno "Would you like to install optional python modules? (Additional database, object storage, YouTube support, wavelet denoise)" 0 0 --defaultno; then
